...
def special(char_name: str, char_class: str) -> str:
    """
    Считает эффект специального умения.
...
def start_training(char_name: str, char_class: str) -> str:
    """
    Режим тренировки: принимает на вход 3 действия.
    -атака
    -защита
    -специальное умение
    Выводит сообщение о результате тренировки
    написать skip, чтобы выйти из режима тренировки.
    """
    if char_class == 'warrior':
